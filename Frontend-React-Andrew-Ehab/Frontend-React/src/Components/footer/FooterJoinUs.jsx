    ...
    return (
        <>
            ...
            >
                ...
                <div className="w-100 h-100 d-flex flex-column justify-content-center align-items-center text-center" style={{ maxWidth: '1000px' }}>
                    <h2 className='fs-1'>Join our Newsletter</h2>
                    <p>Sign up for deals, new products and promotions</p>

                    <div className="d-flex align-items-center border-bottom border-secondary-subtle py-2 mb-3" style={{ maxWidth: '1000px'}}>
